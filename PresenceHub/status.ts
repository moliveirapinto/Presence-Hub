...
export function statusIcon(name: string, sz: "lg" | "sm" = "lg"): string {
  switch (statusKind(name)) {
    ...
    case "available":
      return sz === "lg"
        ? '<svg class="dot-icon" viewBox="0 0 12 12" aria-hidden="true" focusable="false"><polyline points="2.5,6.5 5,9 9.5,3.5" fill="none" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>'
        : '<svg class="dot-icon-sm" viewBox="0 0 12 12" aria-hidden="true" focusable="false"><polyline points="3,6.5 5,8.5 9,3.5" fill="none" stroke="#fff" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>';
    // Away / Appear Away → white clock
    case "away":
      return sz === "lg"
        ? '<svg class="dot-icon" viewBox="0 0 12 12" aria-hidden="true" focusable="false"><circle cx="6" cy="6" r="3.5" fill="none" stroke="#fff" stroke-width="1.3"/><line x1="6" y1="4" x2="6" y2="6" stroke="#fff" stroke-width="1.3" stroke-linecap="round"/><line x1="6" y1="6" x2="7.8" y2="6" stroke="#fff" stroke-width="1.3" stroke-linecap="round"/></svg>'
        : '<svg class="dot-icon-sm" viewBox="0 0 12 12" aria-hidden="true" focusable="false"><circle cx="6" cy="6" r="3.2" fill="none" stroke="#fff" stroke-width="1.8"/><line x1="6" y1="4.2" x2="6" y2="6" stroke="#fff" stroke-width="1.8" stroke-linecap="round"/><line x1="6" y1="6" x2="7.6" y2="6" stroke="#fff" stroke-width="1.8" stroke-linecap="round"/></svg>';
    // Offline / Inactive → diagonal slash (the dot itself is the circle)
    case "offline":
      return sz === "lg"
        ? '<svg class="dot-icon" viewBox="0 0 12 12" aria-hidden="true" focusable="false"><line x1="3" y1="9" x2="9" y2="3" stroke="#fff" stroke-width="2.5" stroke-linecap="round"/></svg>'
        : '<svg class="dot-icon-sm" viewBox="0 0 12 12" aria-hidden="true" focusable="false"><line x1="3" y1="9" x2="9" y2="3" stroke="#fff" stroke-width="2.2" stroke-linecap="round"/></svg>';
